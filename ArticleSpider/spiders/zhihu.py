...
class ZhihuSpider(scrapy.Spider):
    ...
    start_answer_url = "https://www.zhihu.com/api/v4/questions/{0}/answers?include=data%5B*%5D.is_normal%2Cadmin_closed_comment%2Creward_info%2C" \
                       "is_collapsed%2Cannotation_action%2Cannotation_detail%2Ccollapse_reason%2Cis_sticky%2Ccollapsed_by%2Csuggest_edit%2C" \
                       "comment_count%2Ccan_comment%2Ccontent%2Ceditable_content%2Cvoteup_count%2Creshipment_settings%2Ccomment_permission%2C" \
                       "created_time%2Cupdated_time%2Creview_info%2Crelevant_info%2Cquestion%2Cexcerpt%2Crelationship.is_authorized%2Cis_author%2C" \
                       "voting%2Cis_thanked%2Cis_nothelp%2Cis_labeled%2Cis_recognized%2Cpaid_info%3Bdata%5B*%5D.mark_infos%5B*%5D.url%3B" \
                       "data%5B*%5D.author.follower_count%2Cbadge%5B*%5D.topics&offset={2}&limit={1}&sort_by=default&platform=desktop"
    headers = {
        "HOST": "www.zhihu.com",
    ...
    def start_requests(self):
        ...
        browser = webdriver.Chrome(executable_path="C:/Users/shawnchampion/Desktop/utils/chromedriver.exe",
        ...
        browser.find_element_by_css_selector(".SignFlow-accountInput.Input-wrapper input").send_keys("18242093430")
        browser.find_element_by_css_selector(".SignFlow-password input").send_keys(Keys.CONTROL + "a")
        browser.find_element_by_css_selector(".SignFlow-password input").send_keys("L2pPCCK%")
        ...
        while not login_success:
            try:
                ...
                cookie_dict = {}
                import pickle
                pickle.dump(cookies, open('cookies/zhihu_cookie.txt','wb'))
    ...
    def parse_question(self, response):
        ...
        if "QuestionHeader-title" in response.text:
            ...
            comments_num = response.css(".QuestionHeader-Comment button::text").extract_first("")
            ...
            comments_num = response.css("#zh-question-meta-wrap a[name='addcomment']::text").extract_first("")
            item_loader.add_value("comments_num", comments_num)
